...
Alternatively, you can navigating to the [GitHub repository](https://github.com/IdoBar/6003ESC_Workshop1.git) of this tutorial (or any other Binder-ready projects) and click on the Binder badge.

You should see now an RStudio interface in your web browser and are now ready to start working in R in "The Cloud"! `r  fa_cloud(colour = "#5599FF")``r  fa_cloud(colour = "#5599FF")``r  fa_cloud(colour = "#5599FF")`

### Installing R and RStudio locally
Both R and RStudio can be installed locally on any operating system (`r  fa_apple()`, `r  fa_windows(colour = "#5599FF")`, or `r  fa_linux()`, see a [detailed tutorial](https://www.datacamp.com/community/tutorials/installing-R-windows-mac-ubuntu%20)), which provides complete control over the installation, added packages and can be used anywhere without requiring internet connection.
