...
* R WTF: What They Forgot to tell you about R, tips and best practices for working in R ([link](https://rstats.wtf/))  
...
* Plot anything with ggplot2 - [YouTube workshops](https://www.youtube.com/watch?v=h29g21z0a68)  
...
* [paletteer](https://github.com/EmilHvitfeldt/paletteer) -- An R package that let's you use colour palette from a huge range of available packages (see examples of available palettes [here](https://github.com/EmilHvitfeldt/r-color-palettes) and you can even use [TV-themed palettes](https://github.com/Ryo-N7/tvthemes)) 
